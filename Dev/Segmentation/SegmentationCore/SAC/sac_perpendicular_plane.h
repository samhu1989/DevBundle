#ifndef SAC_PERPENDICULAR_PLANE_H
#define SAC_PERPENDICULAR_PLANE_H
#include "sac_plane.h"
#include <memory>
namespace Segmentation{
class SAC_Perpendicular_Plane:public SAC_Plane
{
public:
    SAC_Perpendicular_Plane():SAC_Plane(),axis_(3,arma::fill::zeros),eps_angle_(M_PI/180.0){}
    ...
    virtual Model type(){return PERPENDICULLAR_PLANE;}
protected:
...
#endif // SAC_PERPENDICULAR_PLANE_H
