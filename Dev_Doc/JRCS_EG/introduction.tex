...
As shown in Figure~\ref{fig:teaser}, by solving the problem of coupled joint registration and co-segmentation we not only partition point sets into objects but also align the objects together by solving rigid motion.
