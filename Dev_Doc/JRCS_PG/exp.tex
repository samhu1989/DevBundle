...
\begin{table}
	...
	\begin{tabular}{c c c c}
		...
		JRCS Bilateral & 0.876$\pm$0.012 &\\
		PointNet & 0.402$\pm$0.032 & \\
	\end{tabular}
	\label{tab:seg}
\end{table}
\begin{figure}[htb]
	...
	\caption{\label{fig:seg} Segmentation evaluations on two groups of synthetic data (study room and office desk). Each group of data have 13 point sets.}
\end{figure}
