...
\teaser{
 ...
 \centering
  \caption{
  	(a) are input point sets and user have initialized layout for the $2^{nd}$ set by interactively placing boxes in it. (b) are results of co-segmentation. (c) are the Gaussian centroids in three groups (from top to down) corresponding to three objects}
\label{fig:teaser}
}
