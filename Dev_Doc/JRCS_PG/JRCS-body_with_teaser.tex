...
\teaser{
 ...
 \centering
  \caption{
  	(a) are input point sets and user have initialized layout for the $2^{nd}$ set by interactively placing boxes in it. (b) are result of co-segmentation. (c) are the results of joint registration}
\label{fig:teaser}
}
